...
})(['cursor:pointer;color:', ';display:inline-flex;align-items:center;position:relative;'], function (props) {
	return props.color ? props.color : '#00aac7';
});
	...
	_createClass(ControlButton, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    props = _objectWithoutProperties(_props, ['iconLeft', 'iconRight', 'color', 'onClick', 'children']);

			return _react2.default.createElement(
				Wrapper,
				_extends({ onClick: onClick, color: color }, props, { tabIndex: 0 }),
